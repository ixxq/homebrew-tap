class Awsctx < Formula
  ...
  homepage "https://github.com/xlastz/awsctx"
  version "0.2.3"
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/xlastz/awsctx/releases/download/v0.2.3/awsctx-aarch64-apple-darwin.tar.xz"
      sha256 "8e400fe380a0f46815c24a428465f56e3599d8c251a27de3fd6a0cc922369def"
    end
    if Hardware::CPU.intel?
      url "https://github.com/xlastz/awsctx/releases/download/v0.2.3/awsctx-x86_64-apple-darwin.tar.xz"
      sha256 "6bf029cd28bf6f4e7e8b324c91efbf6277d25ec0e6661d7960ea17f283936fa5"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/xlastz/awsctx/releases/download/v0.2.3/awsctx-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "0b77b4a5a178c0936548e8511387cd626ee6df8675776fc71aabbf640ae81da6"
    end
    if Hardware::CPU.intel?
      url "https://github.com/xlastz/awsctx/releases/download/v0.2.3/awsctx-x86_64-unknown-linux-gnu.tar.xz"
